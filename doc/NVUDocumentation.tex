...
\usepackage{amsmath,xcolor,todonotes,graphicx,marvosym,import,fullpage,textcomp,colortbl,array,pgfplots,lscape,soul,listings,xspace,bm}
...
\newcommand{\kca}{K$_{\text{\scriptsize Ca}}$\xspace}
\newcommand{\ox}{O$_{\text{\scriptsize 2}}$\xspace}
\newcommand{\mus}{$\mu$Ms$^{-1}$ \xspace}
...
\vspace{2cm}
Documentation for Code ``OO-NVU Version 1.2''\\
