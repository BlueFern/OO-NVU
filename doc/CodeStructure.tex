...
\todo[inline]{This is the first draft of this section. Suggestions as to what needs to be expanded further? Include more code listings? --Kon}

\todo[inline]{Remove the code structure files used in the previous documentation version when this version is done. --Kon}
