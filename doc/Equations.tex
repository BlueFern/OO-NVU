...
\hline
$F_{\text{input}}$ 		& amplitude scaling factor 		& 2.5 		& ME \\ % on the basis of Filosa2008
...
\todo[inline]{The remaining equations have not been updated to NVU 1.2 yet!!}
...
\end{equation}
%
Equilibrium state BK-channel (-): \todo{update}
