classdef SMCEC_red < handle
    ...
    methods
        function self = SMCEC_red(varargin)
        ...
        function [du, varargout] = rhs(self, t, u, R, h)
...
%             J_stretch_i = 0;
            ...
            v_KIR_i = p.z_1 * p.K_p - p.z_2;
            g_KIR_i = exp(p.z_5 * v_i + p.z_3 * p.K_p - p.z_4);
...
parser.addParameter('K_p', 9300);   %On: 9300 Off: 3400
