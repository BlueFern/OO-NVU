classdef SMCEC_2_red < handle
    ...
    methods
        function self = SMCEC_2_red(varargin)
        ...
        function [du, varargout] = rhs(self, t, u, R_2, h_2, Ca_i_1, I_i_1, v_i_1, Ca_j_1, I_j_1, v_j_1)
            ...
            v_KIR_i = p.z_1 * p.K_p_2 - p.z_2;
            g_KIR_i = exp(p.z_5 * v_i_2 + p.z_3 * p.K_p_2 - p.z_4);
        ...
        function [Ca_i_2, I_i_2, v_i_2, Ca_j_2, I_j_2, v_j_2] = shared(self, ~, u)
...
parser.addParameter('K_p_2', 9300);     %On: 9300, Off: 3400
