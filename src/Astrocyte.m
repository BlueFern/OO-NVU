classdef Astrocyte < handle
    ...
    methods
        ...
        function [du, varargout] = rhs(self, t, u, J_KIR_i, J_K_NEtoSC)
...
u0(idx.R_k) = 6.0185e-8;
u0(idx.N_Na_k) = 0.00098432;
u0(idx.N_K_k) = 0.0045919;
u0(idx.N_HCO3_k) = 0.00059186;
u0(idx.N_Cl_k) = 0.00036543;
u0(idx.N_Na_s) = 0.0042814;
u0(idx.N_K_s) = 8.0391e-5;
u0(idx.N_HCO3_s) = 0.00042873;
u0(idx.K_p) = 3274.6;
u0(idx.w_k) = 0.00027398;
end
