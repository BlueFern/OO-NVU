classdef NVU < handle
    ...
    methods 
        ...
        function du = rhs(self, t, u)
            ...
            du(self.i_astrocyte, :) = self.astrocyte.rhs(t, ua, J_KIR_i, R, J_VOCC_i, J_NaK_n, NO_n, NO_i);
        ...
        function simulate(self)
            ...
            [~, self.outputs{2}] = self.astrocyte.rhs(self.T, ua, J_KIR_i, R, J_VOCC_i, J_NaK_n, NO_n, NO_i);
...
parser.addParameter('T', linspace(0, 1000, 1000));
