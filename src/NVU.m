classdef NVU < handle
    ...
    methods 
        ...
        function du = rhs(self, t, u)
            ...
            [J_Na_n, NO_n] = self.neuron.shared(t, un);
            ...
            du(self.i_astrocyte, :) = self.astrocyte.rhs(t, ua, J_KIR_i, R, J_VOCC_i, J_Na_n, NO_n, NO_i);
        ...
        function simulate(self)
            ...
            [J_Na_n, NO_n] = self.neuron.shared(self.T, un);
            ...
            [~, self.outputs{2}] = self.astrocyte.rhs(self.T, ua, J_KIR_i, R, J_VOCC_i, J_Na_n, NO_n, NO_i);
...
parser.addParameter('T', linspace(0, 500, 500));
